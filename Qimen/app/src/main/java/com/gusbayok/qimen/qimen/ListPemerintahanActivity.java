...
public class ListPemerintahanActivity extends AppCompatActivity {
    JSONArray rooms = null;
    ArrayList<HashMap<String, String>> arraylist;

    ListView listview;
    PemerintahanAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_pemerintahan);
    ...
    class DownloadJSON extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(ListPemerintahanActivity.this);
                ...
                if (jObj != null) {
                    ...
                    if ("success".equals(status)) {
                        ...
                        for (int i = 0; i < rooms.length(); i++) {
                            ...
                            if("Pemerintahan".equals(menu_title)){
        ...
        protected void onPostExecute(String file_url) {
            ...
            adapter = new PemerintahanAdapter(ListPemerintahanActivity.this, arraylist);
