...
public class PanduanActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.beranda) {
            Intent intentku= new Intent(PanduanActivity.this,MainActivity.class);
            startActivity(intentku);
        } else if (id == R.id.login) {
            Intent intentku= new Intent(PanduanActivity.this,LoginActivity.class);
            startActivity(intentku);
        } else if (id == R.id.about) {
            Intent intentku= new Intent(PanduanActivity.this,TentangActivity.class);
            startActivity(intentku);
        } else if (id == R.id.panduan) {
            Intent intentku= new Intent(PanduanActivity.this,PanduanActivity.class);
            startActivity(intentku);
        } else if (id == R.id.feedback) {
            Intent intentku= new Intent(PanduanActivity.this,FeedbackActivity.class);
            startActivity(intentku);
