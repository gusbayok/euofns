...
public class ListPariwisataActivity extends AppCompatActivity {
    JSONArray rooms = null;
    ArrayList<HashMap<String, String>> arraylist;

    ListView listview;
    PariwisataAdapter adapter;
    ...
    class DownloadJSON extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(ListPariwisataActivity.this);
                ...
                if (jObj != null) {
                    ...
                    if ("success".equals(status)) {
                        ...
                        for (int i = 0; i < rooms.length(); i++) {
                            ...
                            if("Pariwisata".equals(menu_title)){
        ...
        protected void onPostExecute(String file_url) {
            ...
            adapter = new PariwisataAdapter(ListPariwisataActivity.this, arraylist);
